...
(function () {
  ...
  const TRANSLATIONS = {
    de: {
      ...
      "nexttrip.entryTitle": "Ihre nächste Reise",
      "nexttrip.entryText": "Teilen Sie uns ein paar Wünsche mit – so kann Ihr Reisebüro Ihnen schneller ein passendes Angebot erstellen.",
      "nexttrip.entryTextVoucher": "Für Sie liegt noch ein Gutschein über {amount} bereit. Teilen Sie uns ein paar Wünsche mit – so kann Ihr Reisebüro Ihnen schneller ein passendes Angebot erstellen.",
      "nexttrip.entryCta": "Wünsche mitteilen",
      "nexttrip.title": "Nächste Reise planen",
      "nexttrip.intro": "Ein paar Angaben helfen uns, Ihnen ein besseres Angebot zu erstellen. Alle Angaben sind unverbindlich.",
      "nexttrip.voucherNote": "Für diese Reise steht Ihnen noch ein Gutschein über {amount} zur Verfügung. Füllen Sie einfach Ihren Wunsch aus – er wird bei Ihrer nächsten Buchung im Reisebüro (auch online) eingelöst.",
      "nexttrip.back": "Zurück",
      "nexttrip.periodLabel": "Reisezeitraum",
      "nexttrip.periodExact": "Genauer Zeitraum",
      "nexttrip.periodFlexible": "Ungefährer Zeitraum",
      "nexttrip.periodFrom": "Von",
      "nexttrip.periodTo": "Bis",
      "nexttrip.periodFlexibleHint": "z. B. Sommer 2027, Juli/August",
      "nexttrip.destinationLabel": "Reiseziel",
      "nexttrip.destinationSame": "Auch interessiert an {destination}",
      "nexttrip.destinationOtherHint": "Weitere Ziele oder Wünsche",
      "nexttrip.budgetLabel": "Budget (ca.)",
      "nexttrip.budgetHint": "z. B. 2.500",
      "nexttrip.travelersLabel": "Personen",
      "nexttrip.adultsLabel": "Erwachsene",
      "nexttrip.childrenLabel": "Kinder",
      "nexttrip.prioritiesLabel": "Was ist Ihnen wichtig?",
      "nexttrip.priorityBeach": "Strandnähe",
      "nexttrip.prioritySun": "Sonne & Wärme",
      "nexttrip.priorityMountains": "Berge",
      "nexttrip.prioritySea": "Meer",
      "nexttrip.priorityCulture": "Kultur & Städte",
      "nexttrip.priorityRelax": "Ruhe & Erholung",
      "nexttrip.priorityActive": "Aktivität & Sport",
      "nexttrip.priorityAllInclusive": "All-Inclusive",
      "nexttrip.priorityOtherHint": "Sonstiges",
      "nexttrip.emailLabel": "E-Mail-Adresse für die Angebotsübermittlung",
      "nexttrip.emailHint": "name@beispiel.de",
      "nexttrip.consentLabel": "Ich bin einverstanden, dass meine Angaben zur Erstellung eines Angebots gespeichert werden und ich per E-Mail dazu kontaktiert werden darf.",
      "nexttrip.consentRequired": "Bitte stimmen Sie der Speicherung und Kontaktaufnahme zu.",
      "nexttrip.emailRequired": "Bitte geben Sie eine gültige E-Mail-Adresse ein.",
      "nexttrip.submit": "Wünsche absenden",
      "nexttrip.submitting": "Wird gesendet …",
      "nexttrip.errorGeneric": "Ihre Angaben konnten nicht übermittelt werden. Bitte versuchen Sie es erneut.",
      "nexttrip.successTitle": "Vielen Dank!",
      "nexttrip.successText": "Ihre Angaben sind bei uns eingegangen. Ihr Reisebüro meldet sich mit einem passenden Angebot bei Ihnen.",
      "nexttrip.successVoucherNote": "Denken Sie bei Ihrer nächsten Buchung an Ihren Gutschein über {amount} – er wird im Reisebüro (auch online) eingelöst.",
      "nexttrip.backToOverview": "Zur Startseite",
    ...
    en: {
      ...
      "nexttrip.entryTitle": "Your next trip",
      "nexttrip.entryText": "Share a few preferences with us – this helps your travel agency put together a tailored offer faster.",
      "nexttrip.entryTextVoucher": "You still have a voucher worth {amount} waiting. Share a few preferences with us – this helps your travel agency put together a tailored offer faster.",
      "nexttrip.entryCta": "Share your wishes",
      "nexttrip.title": "Plan your next trip",
      "nexttrip.intro": "A few details help us put together a better offer for you. All details are non-binding.",
      "nexttrip.voucherNote": "You still have a voucher worth {amount} available for this trip. Simply fill in your request below – it will be redeemed with your next booking at the travel agency (including online bookings).",
      "nexttrip.back": "Back",
      "nexttrip.periodLabel": "Travel period",
      "nexttrip.periodExact": "Exact dates",
      "nexttrip.periodFlexible": "Approximate period",
      "nexttrip.periodFrom": "From",
      "nexttrip.periodTo": "To",
      "nexttrip.periodFlexibleHint": "e.g. summer 2027, July/August",
      "nexttrip.destinationLabel": "Destination",
      "nexttrip.destinationSame": "Also interested in {destination}",
      "nexttrip.destinationOtherHint": "Other destinations or wishes",
      "nexttrip.budgetLabel": "Budget (approx.)",
      "nexttrip.budgetHint": "e.g. 2,500",
      "nexttrip.travelersLabel": "Travellers",
      "nexttrip.adultsLabel": "Adults",
      "nexttrip.childrenLabel": "Children",
      "nexttrip.prioritiesLabel": "What matters to you?",
      "nexttrip.priorityBeach": "Close to the beach",
      "nexttrip.prioritySun": "Sun & warmth",
      "nexttrip.priorityMountains": "Mountains",
      "nexttrip.prioritySea": "Sea",
      "nexttrip.priorityCulture": "Culture & cities",
      "nexttrip.priorityRelax": "Rest & relaxation",
      "nexttrip.priorityActive": "Activity & sport",
      "nexttrip.priorityAllInclusive": "All-inclusive",
      "nexttrip.priorityOtherHint": "Other",
      "nexttrip.emailLabel": "Email address for sending the offer",
      "nexttrip.emailHint": "name@example.com",
      "nexttrip.consentLabel": "I agree that my details may be stored to create an offer and that I may be contacted by email about it.",
      "nexttrip.consentRequired": "Please agree to the storage and contact terms.",
      "nexttrip.emailRequired": "Please enter a valid email address.",
      "nexttrip.submit": "Send my wishes",
      "nexttrip.submitting": "Sending …",
      "nexttrip.errorGeneric": "Your details could not be submitted. Please try again.",
      "nexttrip.successTitle": "Thank you!",
      "nexttrip.successText": "We've received your details. Your travel agency will get in touch with a suitable offer.",
      "nexttrip.successVoucherNote": "Remember your voucher worth {amount} at your next booking – it will be redeemed at the travel agency (including online bookings).",
      "nexttrip.backToOverview": "Back to start",
    ...
    fr: {
      ...
      "nexttrip.entryTitle": "Votre prochain voyage",
      "nexttrip.entryText": "Indiquez-nous quelques préférences – votre agence de voyage pourra ainsi vous préparer une offre adaptée plus rapidement.",
      "nexttrip.entryTextVoucher": "Un bon d'achat de {amount} vous attend encore. Indiquez-nous quelques préférences – votre agence de voyage pourra ainsi vous préparer une offre adaptée plus rapidement.",
      "nexttrip.entryCta": "Indiquer mes souhaits",
      "nexttrip.title": "Planifier votre prochain voyage",
      "nexttrip.intro": "Quelques informations nous aident à vous préparer une meilleure offre. Toutes les indications sont sans engagement.",
      "nexttrip.voucherNote": "Un bon d'achat de {amount} est encore disponible pour ce voyage. Indiquez simplement votre souhait ci-dessous – il sera utilisé lors de votre prochaine réservation en agence (également en ligne).",
      "nexttrip.back": "Retour",
      "nexttrip.periodLabel": "Période de voyage",
      "nexttrip.periodExact": "Dates précises",
      "nexttrip.periodFlexible": "Période approximative",
      "nexttrip.periodFrom": "Du",
      "nexttrip.periodTo": "Au",
      "nexttrip.periodFlexibleHint": "p. ex. été 2027, juillet/août",
      "nexttrip.destinationLabel": "Destination",
      "nexttrip.destinationSame": "Également intéressé(e) par {destination}",
      "nexttrip.destinationOtherHint": "Autres destinations ou souhaits",
      "nexttrip.budgetLabel": "Budget (env.)",
      "nexttrip.budgetHint": "p. ex. 2 500",
      "nexttrip.travelersLabel": "Voyageurs",
      "nexttrip.adultsLabel": "Adultes",
      "nexttrip.childrenLabel": "Enfants",
      "nexttrip.prioritiesLabel": "Qu'est-ce qui est important pour vous ?",
      "nexttrip.priorityBeach": "Proximité de la plage",
      "nexttrip.prioritySun": "Soleil & chaleur",
      "nexttrip.priorityMountains": "Montagnes",
      "nexttrip.prioritySea": "Mer",
      "nexttrip.priorityCulture": "Culture & villes",
      "nexttrip.priorityRelax": "Calme & détente",
      "nexttrip.priorityActive": "Activité & sport",
      "nexttrip.priorityAllInclusive": "Tout compris",
      "nexttrip.priorityOtherHint": "Autre",
      "nexttrip.emailLabel": "Adresse e-mail pour l'envoi de l'offre",
      "nexttrip.emailHint": "nom@exemple.fr",
      "nexttrip.consentLabel": "J'accepte que mes données soient enregistrées pour l'établissement d'une offre et que je sois contacté(e) par e-mail à ce sujet.",
      "nexttrip.consentRequired": "Veuillez accepter l'enregistrement et la prise de contact.",
      "nexttrip.emailRequired": "Veuillez saisir une adresse e-mail valide.",
      "nexttrip.submit": "Envoyer mes souhaits",
      "nexttrip.submitting": "Envoi en cours …",
      "nexttrip.errorGeneric": "Vos informations n'ont pas pu être transmises. Veuillez réessayer.",
      "nexttrip.successTitle": "Merci !",
      "nexttrip.successText": "Vos informations nous sont bien parvenues. Votre agence de voyage vous contactera avec une offre adaptée.",
      "nexttrip.successVoucherNote": "Pensez à votre bon d'achat de {amount} lors de votre prochaine réservation – il sera utilisé en agence (également en ligne).",
      "nexttrip.backToOverview": "Retour à l'accueil",
    ...
    it: {
      ...
      "nexttrip.entryTitle": "Il vostro prossimo viaggio",
      "nexttrip.entryText": "Condividete alcune preferenze – così la vostra agenzia potrà preparare più rapidamente un'offerta su misura.",
      "nexttrip.entryTextVoucher": "Vi aspetta ancora un buono di {amount}. Condividete alcune preferenze – così la vostra agenzia potrà preparare più rapidamente un'offerta su misura.",
      "nexttrip.entryCta": "Indicare le preferenze",
      "nexttrip.title": "Pianifica il tuo prossimo viaggio",
      "nexttrip.intro": "Alcune informazioni ci aiutano a preparare un'offerta migliore per voi. Tutte le indicazioni non sono vincolanti.",
      "nexttrip.voucherNote": "Per questo viaggio è ancora disponibile un buono di {amount}. Basta compilare la richiesta qui sotto – verrà utilizzato alla prossima prenotazione in agenzia (anche online).",
      "nexttrip.back": "Indietro",
      "nexttrip.periodLabel": "Periodo di viaggio",
      "nexttrip.periodExact": "Date precise",
      "nexttrip.periodFlexible": "Periodo indicativo",
      "nexttrip.periodFrom": "Dal",
      "nexttrip.periodTo": "Al",
      "nexttrip.periodFlexibleHint": "es. estate 2027, luglio/agosto",
      "nexttrip.destinationLabel": "Destinazione",
      "nexttrip.destinationSame": "Interessato/a anche a {destination}",
      "nexttrip.destinationOtherHint": "Altre destinazioni o richieste",
      "nexttrip.budgetLabel": "Budget (circa)",
      "nexttrip.budgetHint": "es. 2.500",
      "nexttrip.travelersLabel": "Persone",
      "nexttrip.adultsLabel": "Adulti",
      "nexttrip.childrenLabel": "Bambini",
      "nexttrip.prioritiesLabel": "Cosa è importante per voi?",
      "nexttrip.priorityBeach": "Vicinanza alla spiaggia",
      "nexttrip.prioritySun": "Sole e caldo",
      "nexttrip.priorityMountains": "Montagne",
      "nexttrip.prioritySea": "Mare",
      "nexttrip.priorityCulture": "Cultura e città",
      "nexttrip.priorityRelax": "Relax e tranquillità",
      "nexttrip.priorityActive": "Attività e sport",
      "nexttrip.priorityAllInclusive": "All-inclusive",
      "nexttrip.priorityOtherHint": "Altro",
      "nexttrip.emailLabel": "Indirizzo e-mail per l'invio dell'offerta",
      "nexttrip.emailHint": "nome@esempio.it",
      "nexttrip.consentLabel": "Acconsento alla memorizzazione dei miei dati per la creazione di un'offerta e a essere contattato/a via e-mail a riguardo.",
      "nexttrip.consentRequired": "Si prega di accettare la memorizzazione e il contatto.",
      "nexttrip.emailRequired": "Inserire un indirizzo e-mail valido.",
      "nexttrip.submit": "Invia le tue preferenze",
      "nexttrip.submitting": "Invio in corso …",
      "nexttrip.errorGeneric": "Non è stato possibile inviare i dati. Riprova.",
      "nexttrip.successTitle": "Grazie!",
      "nexttrip.successText": "Abbiamo ricevuto i vostri dati. La vostra agenzia vi contatterà con un'offerta su misura.",
      "nexttrip.successVoucherNote": "Ricordate il vostro buono di {amount} alla prossima prenotazione – verrà utilizzato in agenzia (anche online).",
      "nexttrip.backToOverview": "Torna alla home",
    ...
    tr: {
      ...
      "nexttrip.entryTitle": "Bir sonraki seyahatiniz",
      "nexttrip.entryText": "Birkaç tercihinizi bizimle paylaşın – böylece seyahat acenteniz size daha hızlı uygun bir teklif hazırlayabilir.",
      "nexttrip.entryTextVoucher": "Sizin için hâlâ {amount} değerinde bir hediye çeki bekliyor. Birkaç tercihinizi bizimle paylaşın – böylece seyahat acenteniz size daha hızlı uygun bir teklif hazırlayabilir.",
      "nexttrip.entryCta": "Taleplerimi bildir",
      "nexttrip.title": "Bir sonraki seyahatinizi planlayın",
      "nexttrip.intro": "Birkaç bilgi, size daha iyi bir teklif hazırlamamıza yardımcı olur. Tüm bilgiler bağlayıcı değildir.",
      "nexttrip.voucherNote": "Bu seyahat için hâlâ {amount} değerinde bir hediye çekiniz mevcut. Aşağıdaki talebi doldurmanız yeterli – bir sonraki rezervasyonunuzda acentede (online dahil) kullanılacaktır.",
      "nexttrip.back": "Geri",
      "nexttrip.periodLabel": "Seyahat dönemi",
      "nexttrip.periodExact": "Kesin tarih",
      "nexttrip.periodFlexible": "Yaklaşık dönem",
      "nexttrip.periodFrom": "Başlangıç",
      "nexttrip.periodTo": "Bitiş",
      "nexttrip.periodFlexibleHint": "örn. 2027 yazı, Temmuz/Ağustos",
      "nexttrip.destinationLabel": "Hedef",
      "nexttrip.destinationSame": "{destination} ile de ilgileniyorum",
      "nexttrip.destinationOtherHint": "Diğer hedefler veya talepler",
      "nexttrip.budgetLabel": "Bütçe (yaklaşık)",
      "nexttrip.budgetHint": "örn. 2.500",
      "nexttrip.travelersLabel": "Kişi sayısı",
      "nexttrip.adultsLabel": "Yetişkin",
      "nexttrip.childrenLabel": "Çocuk",
      "nexttrip.prioritiesLabel": "Sizin için önemli olan nedir?",
      "nexttrip.priorityBeach": "Plaja yakınlık",
      "nexttrip.prioritySun": "Güneş ve sıcaklık",
      "nexttrip.priorityMountains": "Dağlar",
      "nexttrip.prioritySea": "Deniz",
      "nexttrip.priorityCulture": "Kültür ve şehirler",
      "nexttrip.priorityRelax": "Huzur ve dinlenme",
      "nexttrip.priorityActive": "Aktivite ve spor",
      "nexttrip.priorityAllInclusive": "Her şey dahil",
      "nexttrip.priorityOtherHint": "Diğer",
      "nexttrip.emailLabel": "Teklifin gönderileceği e-posta adresi",
      "nexttrip.emailHint": "ad@ornek.com",
      "nexttrip.consentLabel": "Bilgilerimin bir teklif hazırlamak amacıyla saklanmasına ve bu konuda e-posta yoluyla iletişime geçilmesine izin veriyorum.",
      "nexttrip.consentRequired": "Lütfen saklama ve iletişim iznini onaylayın.",
      "nexttrip.emailRequired": "Lütfen geçerli bir e-posta adresi girin.",
      "nexttrip.submit": "Taleplerimi gönder",
      "nexttrip.submitting": "Gönderiliyor …",
      "nexttrip.errorGeneric": "Bilgileriniz gönderilemedi. Lütfen tekrar deneyin.",
      "nexttrip.successTitle": "Teşekkürler!",
      "nexttrip.successText": "Bilgileriniz bize ulaştı. Seyahat acenteniz size uygun bir teklifle geri dönecek.",
      "nexttrip.successVoucherNote": "Bir sonraki rezervasyonunuzda {amount} değerindeki hediye çekinizi hatırlatın – acentede (online dahil) kullanılacaktır.",
      "nexttrip.backToOverview": "Ana sayfaya dön",
    ...
    el: {
      ...
      "nexttrip.entryTitle": "Το επόμενο ταξίδι σας",
      "nexttrip.entryText": "Πείτε μας μερικές προτιμήσεις σας – έτσι το ταξιδιωτικό σας γραφείο θα ετοιμάσει πιο γρήγορα μια κατάλληλη προσφορά.",
      "nexttrip.entryTextVoucher": "Σας περιμένει ακόμη ένα κουπόνι αξίας {amount}. Πείτε μας μερικές προτιμήσεις σας – έτσι το ταξιδιωτικό σας γραφείο θα ετοιμάσει πιο γρήγορα μια κατάλληλη προσφορά.",
      "nexttrip.entryCta": "Δηλώστε τις επιθυμίες σας",
      "nexttrip.title": "Σχεδιάστε το επόμενο ταξίδι σας",
      "nexttrip.intro": "Λίγα στοιχεία μάς βοηθούν να σας ετοιμάσουμε μια καλύτερη προσφορά. Όλα τα στοιχεία είναι χωρίς δέσμευση.",
      "nexttrip.voucherNote": "Για αυτό το ταξίδι έχετε ακόμη διαθέσιμο ένα κουπόνι αξίας {amount}. Απλώς συμπληρώστε την επιθυμία σας παρακάτω – θα εξαργυρωθεί στην επόμενη κράτησή σας στο γραφείο (και online).",
      "nexttrip.back": "Πίσω",
      "nexttrip.periodLabel": "Χρονικό διάστημα ταξιδιού",
      "nexttrip.periodExact": "Συγκεκριμένες ημερομηνίες",
      "nexttrip.periodFlexible": "Κατά προσέγγιση διάστημα",
      "nexttrip.periodFrom": "Από",
      "nexttrip.periodTo": "Έως",
      "nexttrip.periodFlexibleHint": "π.χ. καλοκαίρι 2027, Ιούλιος/Αύγουστος",
      "nexttrip.destinationLabel": "Προορισμός",
      "nexttrip.destinationSame": "Ενδιαφέρομαι και για {destination}",
      "nexttrip.destinationOtherHint": "Άλλοι προορισμοί ή επιθυμίες",
      "nexttrip.budgetLabel": "Προϋπολογισμός (περίπου)",
      "nexttrip.budgetHint": "π.χ. 2.500",
      "nexttrip.travelersLabel": "Άτομα",
      "nexttrip.adultsLabel": "Ενήλικες",
      "nexttrip.childrenLabel": "Παιδιά",
      "nexttrip.prioritiesLabel": "Τι είναι σημαντικό για εσάς;",
      "nexttrip.priorityBeach": "Κοντά σε παραλία",
      "nexttrip.prioritySun": "Ήλιος & ζέστη",
      "nexttrip.priorityMountains": "Βουνό",
      "nexttrip.prioritySea": "Θάλασσα",
      "nexttrip.priorityCulture": "Πολιτισμός & πόλεις",
      "nexttrip.priorityRelax": "Ηρεμία & χαλάρωση",
      "nexttrip.priorityActive": "Δραστηριότητα & αθλητισμός",
      "nexttrip.priorityAllInclusive": "All-inclusive",
      "nexttrip.priorityOtherHint": "Άλλο",
      "nexttrip.emailLabel": "Διεύθυνση e-mail για την αποστολή της προσφοράς",
      "nexttrip.emailHint": "name@example.gr",
      "nexttrip.consentLabel": "Συμφωνώ τα στοιχεία μου να αποθηκευτούν για τη δημιουργία προσφοράς και να επικοινωνήσετε μαζί μου μέσω e-mail σχετικά.",
      "nexttrip.consentRequired": "Παρακαλούμε αποδεχθείτε την αποθήκευση και την επικοινωνία.",
      "nexttrip.emailRequired": "Παρακαλούμε εισαγάγετε μια έγκυρη διεύθυνση e-mail.",
      "nexttrip.submit": "Αποστολή επιθυμιών",
      "nexttrip.submitting": "Αποστολή …",
      "nexttrip.errorGeneric": "Τα στοιχεία σας δεν ήταν δυνατό να υποβληθούν. Δοκιμάστε ξανά.",
      "nexttrip.successTitle": "Ευχαριστούμε!",
      "nexttrip.successText": "Τα στοιχεία σας παραλήφθηκαν. Το ταξιδιωτικό σας γραφείο θα επικοινωνήσει μαζί σας με μια κατάλληλη προσφορά.",
      "nexttrip.successVoucherNote": "Θυμηθείτε το κουπόνι σας αξίας {amount} στην επόμενη κράτησή σας – θα εξαργυρωθεί στο γραφείο (και online).",
      "nexttrip.backToOverview": "Επιστροφή στην αρχική",
